...
def product(name):
    print(name)
    x = input('what is the product name? ')
    y = float(input('how muche is the product? '))
    z = float(input('how many product did you take? '))
    u = y * z
    print(f'the name of the product is {x}')
    print(f'Total price: ${u}')
product(name='')
