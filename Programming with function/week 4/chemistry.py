...
def main():
    ...
    atomic = (input("Enter the mass in grams of the sample:"))
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for SYMBOL_INDEX, QUANTITY_INDEX in symbol_quantity_list():

        atomic_mass = dict(SYMBOL_INDEX)
        total_mass += atomic_mass * QUANTITY_INDEX
        
    # Return the total mass.
    # for element in symbol_quantity_list:

    #     SYMBOL_INDEX = element[0]
    #     QUANTITY_INDEX = element[1]

    #     amass = dict[SYMBOL_INDEX]
    #     atomicmass = amass[1]
    #     product = atomicmass * QUANTITY_INDEX
    ...
    for inner_list in periodic_table_dict:
        ...
        atomic = inner_list[ATOMIC_MASS_INDEX]
        print(name, atomic)
