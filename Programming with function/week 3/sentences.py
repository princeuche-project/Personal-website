...
def main():
    ...
    # print(f'{determiner.capitalize()} {noun} {verb} {preposition} {preposition_phrase} ')
...
def get_noun(quantity):
    ...
    if quantity == 1:
        nouns = [ "bird", "boy", "car", "cat", "child","dog", "girl", "man", "rabbit"]
...
def get_verb(quantity, tense):
     #get_verb = get_verb(quantity, tense)
...
def get_prepositional_phrase(quantity):
    ...
    for i in range(quantity):
        if quantity == 1:
            ...
            prepostion_phrase = (prepostion_phrase)
