...
# if answer == 'run':
#     print()
#     answer = input('You have two ways out. the direction that lead to the crowd and the lonly area. are you going to run to the [CROWD/LONELY AREA]? ')
#     print()
#     if answer == 'crowd':
#        print('You made the wrong choice because the animal is going to harm the people around that area. please reconsider your decision')
#        print()
#     elif answer == 'lonely area':
...
#             print('Now the police are here to rescue you, You are safe now. You have one point congratulations!')
#     elif answer == 'your brother':
#         print('wrong choice because your brother can not help you at the moment. Try again!')
# else:
#    answer == 'fight'
#    print()
